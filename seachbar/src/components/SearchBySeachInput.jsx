...
const SearchBySeachInput = () => {
 const [search, setSearch] = useState("");
  ...
  return (
    <>
      <div className="flex justify-between items-center mb-8 pt-24 px-24">
  <h1 className='text-4xl underline text-center '>
           Search By Name
            ...
            <button className='p-4 bg-slate-500 rounded-xl '> 
                <Link to="/">Back to React Table</Link>
            </button>
...
export default SearchBySeachInput